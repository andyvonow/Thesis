...
for pos = 1:3
    ...
    for variable = 1:3
        switch variable
            case 1; ForceVar = "Force_FZMIN"; AccelVar = "XMAX";
            case 2; ForceVar = "Force_FZMIN"; AccelVar = "XMIN";
                            ...
                            if contains(VariableNames(m),"Accel")
                                ...
                                LogFitXaxis = linspace(min(logYaxis),max(logYaxis));
                                                            if SectionName{1}(2) == '1'
                                                                ...
                                                                xlabel("a + b * log_2("+AccelVar+" + abs(min("+AccelVar+")) + 1)"+newline+AccelVar+" (g)");
                                                                ylabel("Actual: "+xLab);
        ...
        %%
        %plot graphs?
        if NCV == 4 && locat == "Shank" && AccelVar == "XMIN"
            ...
            if true
                ...
                legend("Original Data",...
                    "Linear Fit, RMSE: " + round(OldLinFit.RMSE,1),...
                    "Log Fit, RMSE: " + round(logfitted.RMSE,1),...
                    'Location','southeast')
                round(OldLinFit.Rsquared.Ordinary,2)
                round(logfitted.Rsquared.Ordinary,2)
            "" ;   
            else
                figure(9); clf(9);
                hold on
